	...
	public static void main(String[] args) {
		...
		int contador1 = 0, contador2 = 0;
		 for (int repeticao = 1; repeticao <= 50; repeticao++) {
			...
			if (idade1 <= 18) {
				JOptionPane.showMessageDialog(null, "O aluno tem até 18 anos: ", "NOME DO ALUNO É: " +nome,
						JOptionPane.INFORMATION_MESSAGE);
				contador1++;
			} else if (idade1 >= 18) {
				JOptionPane.showMessageDialog(null, "O aluno tem acima de 18 anos: ", "NOME DO ALUNO É:"+nome,
						JOptionPane.INFORMATION_MESSAGE);
				contador2++;
			}
		}
