...
public class c08ex07 {
	...
	if (idade1 <= 12) {
		JOptionPane.showMessageDialog(null, "O aluno tem até 12 anos: ", "Nome do aluno é "+nome,
		JOptionPane.INFORMATION_MESSAGE);
		soma += idade1;
		contador1++;
	} else if (idade1 >= 30) {
		JOptionPane.showMessageDialog(null, "O aluno tem acima de 30 anos: ", "Nome do aluno é "+nome,
		JOptionPane.INFORMATION_MESSAGE);
		soma += idade1;
		contador2++;
	}
	   ...
	   "Quantidade de números dos alunos tem até 18 anos: " + contador1 + "\n"
	   + "Quantidade de números dos alunos tem acima de 18 anos: " + contador2+ "\n"+ "Media é: "+media,
