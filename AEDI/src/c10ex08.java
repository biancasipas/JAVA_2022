...
public class c10ex08 {
	public static void main(String[] args) {
		...
		Scanner arquivo = new Scanner(c10ex08.class.getResourceAsStream("c10ex08.txt"));
		...
		System.out.println("População: " + soma);
		...
		System.out.println("Cidade com menor populaçõa: " + menorcidade);
