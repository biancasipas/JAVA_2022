...
public class AlunoExecutavel {
    public static void main(String[] args) {
        ...
        System.out.println("ESCOLHA  [1]CRIAR ALUNO  [2] ALTERAR [3]EXIBIR ");
        ...
        switch (resp) {
            ...
            case 1://criar aluno
                ...
                System.out.println("4.Aluno ainda não criado. ");
                ...
                switch (digite) {
                    ...
                    case 2:
                        ...
                        teclado.nextLine();//entendeu? aquele bug nao pode ler String depois de Int tem que coloca r teclado.nextlIne
                        System.out.println("Deseja criar com email? [1] SIM [2]NAO");
                        resp = teclado.nextInt();
                        teclado.nextLine();
                        switch (resp) {
                                            ...
                                            case 1://com email
                                                ...
                                                switch (resp) {//com ou sem inicio semestre
                                                    case 1://com inicio semestre
                                                        ...
                                                        listaAluno.add(new AlunoDePosGraduacao(nome, matricula, email, Graduacao, Posgraduacao, semestreInicio));
                                                        break;
