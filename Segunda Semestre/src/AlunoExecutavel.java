...
public class AlunoExecutavel {
	public static void main(String[] args) {
		...
		int resp, matricula, anoEntrada;
		String email, nome, curso, Graduacao, Posgraduacao, semestreInicio;
		Scanner teclado = new Scanner(System.in);
		System.out.println("ESCOLHA  [1]CRIAR ALUNO  [2] ALTERAR [3]EXIBIR [0]SAIR ");
		...
		while (resp!=0) {
			...
			case 1://criar
				if (listaAluno.size()>0) {  //temos agora que exibir se nao existe aluno vdd 
					listaAluno.remove(0);
				}
				System.out.println("Digite qual tipo de aluno criar: ");
				...
				case 1:// aluno 
						...
						teclado.nextLine();
						System.out.println("Deseja criar com email? [1] SIM [2]NAO");
						resp = teclado.nextInt();
						teclado.nextLine();
						switch (resp) {
						case 1:// com email
				...
				case 2:// alunoGraduacao
						...
						case 1:// com email
							System.out.print("Qual seu email: ");
							email = teclado.nextLine();
							System.out.println("Qual curso de Graduacao: ");
							curso = teclado.nextLine();
							System.out.println("Criar com Ano de Entrada? [1] SIM [2] NAO");
							resp = teclado.nextInt();
							...
							break;
						case 2:// sem email
							System.out.println("Digite qual curso de Graduacao: ");
							curso = teclado.nextLine();
							System.out.println("Criar com Ano de Entrada? [1] SIM [2] NAO");
							resp = teclado.nextInt();
							switch (resp) {// com ou sem ano de entraDa
					...
					case 3:
						...
						case 1:// com email
							System.out.print("Qual seu email: ");
							email = teclado.nextLine();
							System.out.println("Digite sua graduacao: ");
							Graduacao = teclado.nextLine();
							System.out.println("Qual curso de Pos Graduacao: ");
							Posgraduacao = teclado.nextLine();
							System.out.println("Criar com Inicio de Semestre? [1] SIM [2] NAO");
							resp = teclado.nextInt();
							teclado.nextLine();
						
							switch (resp) {// com ou sem inicio semestre
							case 1:// com inicio semestre
								System.out.println("Digite o inicio do semestre(mm/YYYY): ");
						...
						case 2:// sem email
							System.out.println("Digite qual curso de Graduacao: ");
							curso = teclado.nextLine();
							System.out.println("Digite o curso de Pos Graduacao: ");
							Posgraduacao = teclado.nextLine();
							System.out.println("Criar com início do semestre? [1] SIM [2] NAO");
							resp = teclado.nextInt();
							teclado.nextLine();
							...
							case 1:// com inicio do semestre
								...
								semestreInicio = teclado.nextLine();
								listaAluno
										.add(new AlunoDePosGraduacao(nome, matricula, curso, Posgraduacao, semestreInicio));
								break;
							case 2:// sem ano de entrada
			...
			case 2://alterar
				...
				System.out.println("QUAL TIPO DE ALUNO DESEJA ALTERAR:[1] ALUNO [2]ALUNO DE GRADUACAO [3]ALUNO DE POS GRADUACAO  ");
				resp = teclado.nextInt();
				teclado.nextLine();
				switch(resp) {
					case 1: 
				
						System.out.println("O QUE DESEJA ALTERAR : [1]NOME [2]EMAIL");
						resp = teclado.nextInt();
						switch(resp) {
							case 1:
					...
					case 2:
						System.out.println("O que deseja alterar: [1]NOME [2] EMAIL [3] CURSO DE GRADUACAO");
						resp = teclado.nextInt();
						teclado.nextLine();
						switch(resp) {
							case 1:
					...
					break;
					case 3:
						System.out.println("O que deseja alterar: [1]NOME [2] EMAIL [3] POS GRADUACAO");
						resp = teclado.nextInt();
						teclado.nextLine();
						switch(resp) {
						case 1:
			...
			resp = teclado.nextInt(); //ai aqui ele vai voltar pra ca
		}
		teclado.close();
	}
}