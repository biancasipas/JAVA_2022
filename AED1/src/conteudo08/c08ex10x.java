...
public class c08ex10x {
	...
	nome_produto = JOptionPane.showInputDialog(null,"Qual � o nome do produto : ");
    quantidade = JOptionPane.showInputDialog(null,"Quantidade: ");
    preco_unitario = JOptionPane.showInputDialog(null,"Pre�o Unitario: ");
