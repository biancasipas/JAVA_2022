...
public class c08ex13 {
	...
	Scanner arquivo = new Scanner(E01825C.class.getResourceAsStream("conteudo08.c08ex13.txt"));
	...
	System.out.println("A porcentagem de eleitores �: "+percentual_eleitores+"%");
	...
	System.out.println(" Cidades com mais de um milh�o de Habitantes: "+milhao);
    System.out.println(" Cidades com mais de uma cidade com mais mulheres: "+mais_mulheres);
    System.out.println(" Cidade com menor n�mero de habitantes: "+menor_nome);
