...
public class c10ex06 {
	...
	B = JOptionPane.showInputDialog(null, "Qual � o valor de B: ");
	C = JOptionPane.showInputDialog(null,"Qual � o valor de C: ");
	...
	JOptionPane.showMessageDialog(null,"Dist�ncia: "+distancia);
